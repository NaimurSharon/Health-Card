...
@section('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Today's Video Consultations -->
            <div class="content-card rounded-lg p-6 shadow-sm">
                <h4 class="text-xl font-semibold text-gray-900 border-b border-gray-200/60 pb-3 mb-4">Today's Video
                    Consultations</h4>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">
                                                ...
                                                @if($consultation->user->student)
                                                    <span
                                                        class="text-xs text-gray-500">({{ $consultation->user->student->roll_number ?? '' }})</span>
                                                @endif
                                            </p>
                                        </div>
                                    </div>
            ...
            <div class="content-card rounded-lg p-6 shadow-sm">
                <h4 class="text-xl font-semibold text-gray-900 border-b border-gray-200/60 pb-3 mb-4">Upcoming Consultations
                </h4>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm text-gray-700">
                                        {{ $consultation->symptoms ? Str::limit($consultation->symptoms, 40) : 'No symptoms noted' }}
                                    </p>
                                    @if($consultation->duration)
                                        <p class="text-xs text-gray-600 mt-1">Duration: {{ gmdate('H:i:s', $consultation->duration) }}
                                        </p>
                                    @endif
                                </div>
                                <a href="{{ route('doctor.video-consultation.join', $consultation->id) }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="content-card rounded-lg p-6 shadow-sm">
                <h4 class="text-xl font-semibold text-gray-900 border-b border-gray-200/60 pb-3 mb-4">Pending Treatment
                    Requests</h4>
            ...
            <div class="content-card rounded-lg p-6 shadow-sm">
                <h4 class="text-xl font-semibold text-gray-900 border-b border-gray-200/60 pb-3 mb-4">Recent Medical Records
                </h4>
                    ...
                    <div class="space-y-4">
                        @foreach($recentRecords as $record)
                            ...
                            ($record->record_type == 'checkup' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800') }}">
                                    ...
                                    <p class="text-sm text-gray-600 line-clamp-2">{{ $record->diagnosis ?? 'No diagnosis recorded' }}
                                    </p>
