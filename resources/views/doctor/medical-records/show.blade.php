    ...
    <div class="space-y-6">
            ...
            <div class="table-header px-6 py-4 flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">{{ $medicalRecord->record_date->format('F j, Y') }} -
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-3 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-lg text-gray-900">
                                    {{ $medicalRecord->student->class->name ?? 'N/A' }} -
                                    {{ $medicalRecord->student->section->name ?? 'N/A' }}
                                </p>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div>
                                ...
                                <p
                                    class="text-lg text-gray-900 {{ $medicalRecord->student->blood_group ? 'text-red-600 font-semibold' : '' }}">
                ...
                <!-- Medical Details -->
                <div class="content-card rounded-lg p-6 shadow-sm">
                    <h4 class="text-xl font-semibold text-gray-900 border-b border-gray-200/60 pb-3 mb-4">Medical Details
                    </h4>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900">
                                {{ $medicalRecord->record_date->format('F j, Y') }}
                            </p>
                        </div>
                        <div>
        ...
        ($medicalRecord->record_type == 'vaccination' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <!-- @if($medicalRecord->prescription)
                                    <div>
                                        ...
                                        <div class="bg-green-50 rounded-lg p-4">
                                            <a href="{{ asset('public/storage/' . $medicalRecord->prescription) }}" target="_blank"
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-600 mb-2">Prescription</p>
                            <div class="bg-green-50 rounded-lg p-4">
                                <p class="text-gray-700">{{ $medicalRecord->prescription }}</p>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                <!-- Record Information -->
                <div class="content-card rounded-lg p-6 shadow-sm">
                    <h4 class="text-xl font-semibold text-gray-900 border-b border-gray-200/60 pb-3 mb-4">Record Information
                    </h4>
                ...
                @if($medicalRecord->follow_up_date)
                    <div class="content-card rounded-lg p-6 shadow-sm border-l-4 border-green-500">
                        <h4 class="text-xl font-semibold text-gray-900 border-b border-gray-200/60 pb-3 mb-4">Follow-up
                            Information</h4>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="text-lg font-semibold {{ $medicalRecord->follow_up_date->isPast() ? 'text-red-600' : 'text-green-600' }}">
                ...
                <div class="content-card rounded-lg p-6 shadow-sm border border-red-200">
                    ...
                    <div class="space-y-3">
                        ...
                        <form action="{{ route('doctor.medical-records.destroy', $medicalRecord) }}" method="POST"
                            class="w-full">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
