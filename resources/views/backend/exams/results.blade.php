...
<div class="space-y-6">
    ...
    <div class="content-card rounded-lg overflow-hidden">
        <div class="table-header px-6 py-4">
            <div class="flex justify-between items-center">
                <div>
                    <h3 class="text-2xl font-bold">Exam Results</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="content-card rounded-lg p-6 text-center">
            <div class="text-2xl font-bold text-green-600">
                {{ $attempts->where('score', '>=', $exam->passing_marks)->count() }}
            </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200/60">
                    @forelse($attempts as $index => $attempt)
                        @php
                            $percentage = $attempt->score ? ($attempt->score / $exam->total_marks) * 100 : 0;
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-8 text-center text-gray-500">
                                ...
                                <p class="text-sm mt-2">No students have completed this exam yet.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
    ...
    <div class="content-card rounded-lg p-6">
        <h4 class="text-lg font-semibold mb-4">Export Results</h4>
