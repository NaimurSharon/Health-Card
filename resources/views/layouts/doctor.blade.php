...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon"
        href="{{ asset('public/storage/' . setting('site_favicon', 'logo/amardesh-shadhinotar-kotha-bole.webp')) }}"
        type="image/webp">
                ...
                <div class="flex items-center justify-between px-6 py-3">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div x-show="incomingCall"
                            class="flex items-center space-x-2 bg-orange-100 text-orange-800 px-3 py-1 rounded-full">
    ...
    <div x-show="incomingCall || upcomingConsultations.length > 0"
        ...
        <div x-show="incomingCall"
            ...
            <div class="px-6 pt-6 pb-2 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        ...
                        <div
                            class="relative bg-blue-50 text-blue-600 w-10 h-10 rounded-full flex items-center justify-center">
                ...
                <div
                    class="bg-red-50 text-red-600 text-xs font-bold px-3 py-1 rounded-full border border-red-100 flex items-center gap-1">
            ...
            <div class="px-6 py-4">
                <div class="flex items-center space-x-4 mb-6">
                    <div
                        class="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center flex-shrink-0 border border-gray-100 shadow-sm">
                        <i class="fas fa-user text-gray-400 text-3xl"></i>
                    </div>
                    <div class="flex-1 min-w-0">
                        <h4 class="text-xl font-bold text-gray-900 truncate"
                            x-text="currentCall?.student_name || 'Student'"></h4>
                ...
                <div class="mt-4 text-center">
                    <p class="text-gray-400 text-xs font-medium">
                        Auto-reject in <span x-text="callTimer"
                            class="text-gray-600 w-4 inline-block text-center"></span>s
                    </p>
                </div>
            </div>
        </div>
        ...
        <div x-show="upcomingConsultations.length > 0 && !incomingCall"
            ...
            <div class="px-6 py-4 border-b border-gray-50 flex items-center justify-between bg-white">
                ...
                <button @click="upcomingConsultations = []"
                    class="w-8 h-8 rounded-full hover:bg-gray-50 flex items-center justify-center text-gray-400 hover:text-gray-600 transition-colors">
            ...
            <div class="max-h-[20rem] overflow-y-auto scrollbar-thin">
                <template x-for="consultation in upcomingConsultations" :key="consultation.id">
                    <div class="p-4 border-b border-gray-50 hover:bg-gray-50/50 transition-colors group cursor-pointer">
                        <div class="flex items-center space-x-4">
                            <div
                                class="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center flex-shrink-0 text-gray-400 border border-gray-100 group-hover:border-blue-100 group-hover:bg-blue-50 group-hover:text-blue-500 transition-all">
                                <i class="fas fa-user text-lg"></i>
                            </div>
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between mb-1">
                                    <h4 class="font-bold text-gray-900 text-sm truncate"
                                        x-text="consultation.student_name"></h4>
                                    <span
                                        class="bg-gray-100 text-gray-600 text-[10px] font-bold px-2 py-0.5 rounded-full"
            ...
            <div class="bg-gray-50/50 px-6 py-3 border-t border-gray-50">
                <a href="/doctor/video-consultations"
                    class="text-gray-500 hover:text-gray-900 text-xs font-semibold flex items-center justify-center transition-colors">
                    View Full Schedule
                </a>
            </div>
        </div>
