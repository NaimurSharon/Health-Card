...
<div class="space-y-6">
    ...
    <div class="content-card rounded-lg p-4 sm:p-6">
        <form action="{{ isset($student) ? route('principal.students.update', $student->id) : route('principal.students.store') }}" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="date_of_birth" required 
                           value="{{ old('date_of_birth', optional($student->user)->date_of_birth ? \Carbon\Carbon::parse($student->user->date_of_birth)->format('Y-m-d') : '') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div>
