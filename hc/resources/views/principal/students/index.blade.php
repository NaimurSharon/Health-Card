            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Class & Section</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-500">Section {{ $student->section->name ?? 'N/A' }} | Roll: {{ $student->roll_number }}</div>
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="{{ route('principal.students.destroy', $student->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
