...
Route::prefix('doctor')->name('doctor.')->middleware(['auth', 'role:doctor'])->group(function () {
    ...
    // Appointments
    Route::get('/consultations', [DoctorAppointmentController::class, 'index'])->name('consultations.index');
    Route::get('/consultations/{consultation}', [DoctorAppointmentController::class, 'show'])->name('consultations.show');
    Route::post('/consultations/{consultation}/status', [DoctorAppointmentController::class, 'updateStatus'])->name('consultations.update-status');
    Route::post('/consultations/{consultation}/medical-record', [DoctorAppointmentController::class, 'createMedicalRecord'])->name('consultations.create-medical-record');
